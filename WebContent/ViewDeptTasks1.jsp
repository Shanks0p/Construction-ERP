...
<body>
<h3 style="position:absolute; left:3rem; top:1rem; font-size:1.5rem;"  ><a href="DeptMenu.html" style="text-decoration:none; color:#FFE743;">Main Menu</a></h3>
<h3 style="position:absolute; right:3rem; top:1rem; font-size:1.5rem;"><a href="DeptProDet.jsp?pid=<%=getset.getPid() %>" style="text-decoration:none; color:#FFE743;">Back</a></h3>
<div class="container">
  ...
  try
  {
  		PreparedStatement ps1 = con.prepareStatement("SELECT * FROM dept_task WHERE pid=?");
  		ps1.setInt(1,pid);
  ...
  <article class="episode">
    ...
    <div class="episode__content">
      ...
      <p><%=rs.getString(6) %></p>
       ...
       <div class="story" style="position:relative; top:-1rem;">
