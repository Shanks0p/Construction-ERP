...
<div class="main-container">
  <div class="heading">
    <div class="title">
     ...
     <div class="sub-main">
      <a href="EmpMenu.html" style="text-decoration: none;"><button class="button-one">Go Back?</button></a>
    </div>
  </div>
<br>
<br>
...
try
{
	PreparedStatement ps1 = con.prepareStatement("SELECT * FROM project p JOIN empasproj e ON p.pid=e.pid AND e.eid=?");
	ps1.setInt(1,eid);
    ...
    <div class="card card-1">
      <p class="card__exit"><i class="fas fa-times"></i></p>
			        ...
			        <br><br><a href="EmpProDet.jsp?pid=<%=rs.getInt(1) %>" style="text-decoration: none; " >View Full Details</a></h4>
