...
<title>Add Respective Departments</title>
  <!-- plugins:css -->
...
<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Add Respective Department</h6>
                  <br>
		  ...
		  try
		  {
		  		PreparedStatement ps1 = con.prepareStatement("SELECT * FROM dept"); 
		  		ResultSet rs = ps1.executeQuery();
		  		
		  		while(rs.next())
		  		{
		  		PreparedStatement ps2 = con.prepareStatement("SELECT * FROM deptasproj"); 
		  ...
		  %>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          {
                        	  %>
                          <td><a href="AddRDept2.jsp?pid=<%=pid%>&did=<%=rs.getInt(1)%>&name=<%=rs.getString(2)%>"><%=add %></a></td>
                          <%
                          }
                          else
                          {
          ...
          %>
              ...
              %>
					<div>
                  <a href="ViewPro.jsp?pid=<%=getset.getPid() %>" style=" text-decoration: none; "><button type="button" name="Back" style="width:100%; font-size: 24px; " class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Go Back</button></a>
                  </div>  
              <br>
					<div>
              ...
              else
              {
                %>
                	<div>
                  <a href="EmpProDet.jsp?pid=<%=getset.getPid() %>" style=" text-decoration: none; "><button type="button" name="Back" style="width:100%; font-size: 24px; " class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Go Back</button></a>
                  </div>  
              <br>
					<div>
                  <a href="EmpMenu.html" style=" text-decoration: none; "><button type="button" name="Main Menu" style="width:100%; font-size: 24px;" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Main Menu</button></a>
                  </div>   
                  <%
                  }
                  %>          
