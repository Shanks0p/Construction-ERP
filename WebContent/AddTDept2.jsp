  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
              <a href="#" aria-expanded="false" >Pages</a>
	          </li>
	          <li>
              <a href="#">Portfolio</a>
	          </li>
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" action="AddTDept3" method="post">
	          ...
	          <input type="reset" value="RESET" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">
                  ...
                  {
                  %>
                  <a href="AddTDept1.jsp" style=" text-decoration: none;"><button type="button" name="Back" style="width:100%;" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">BACK</button></a>
                  <%
                  }
                  %>
                  </div>
