...
<head>
  ...
  <link rel="stylesheet" href="HoverCard2/style.css">
    ...
    <title>Add Task to Employee</title>
...
%>        
    ...
    <br>
                  ...
                  <a href="ViewPro.jsp" style=" text-decoration: none; "><button type="button" name="back" style="width:100%; font-size: 24px; overflow-x:visible; " class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Back</button></a>
                  </div>
