...
<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">View Department Details</h6>
                  <br>
                  <form action="search.jsp"  style="transform:translate(1300px, 0); border-color: 2px solid black;">
                  <input type="text" name="id1" id="id1" placeholder="Enter your Employee ID" >
                  <a href="search.jsp" style=" text-decoration: none;"><button type="submit" name="button" >
                  Submit</button></a>
                  </form>
                  <br>
                  <div class="table-responsive">
                    <table class="table table-hoverable" style="text-align-last:center;">
		  ...
		  %>
                      <tbody>
                        <tr>
                          ...
                          <td><a href="RemDept.jsp?id=<%=rs.getInt(1)%>">Remove</a></td>
                        </tr>
          ...
          %>
              ...
              <br>
					<div>
                  <a href="AdminMenu.html" style=" text-decoration: none; "><button type="button" name="Main Menu" style="font-size: 24px; width:100%;" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Main Menu</button></a>
                  </div>         
</body>
</html>