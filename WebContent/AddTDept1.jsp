...
<a href="AddTDept2.jsp?id=<%=rs.getInt(1)%>&pid=<%=request.getParameter("pid") %>&name=<%=rs.getString(2) %>" style="text-decoration:none;">
          ...
          <div class="slide slide2">
                ...
                <div class="content">
                    ...
                    <p><b>Type of Job</b> : <%=rs.getString(7) %></p>
                    <p><b>Address</b> : <%=rs.getString(6) %></p>
...
%>        
    ...
    <br>
                  ...
                  <a href="EmpProDet.jsp?pid=<%=getset.getPid() %>" style=" text-decoration: none; "><button type="button" name="back" style="width:100%; font-size: 24px;" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Back</button></a>
    <br>
    <br>
					<div class="btn-gradient-primary">
