...
/**
 * Servlet implementation class AddTDept3
 */
@WebServlet("/AddTDept3")
public class AddTDept3 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			PreparedStatement ps1 = con.prepareStatement("INSERT INTO dept_task VALUES (?,?,?,?,?,?,?,?,?,?,?)");
			ps1.setInt(1, tid);
			ps1.setInt(2, getset.getDid());
			...
			if(rs>0)
			{
				response.sendRedirect("AddTDept1.jsp");
			}
			else
			{
				response.sendRedirect("AddTDept2.jsp");
			}
		}
		catch(Exception e)
		{
